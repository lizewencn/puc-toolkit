...
The target IP suffix remains part of generated personnel identifiers to preserve the existing deployment convention. Do not require a police-type GUID: the deployed frontend exposes it only as an optional field when number type `102` is selected.
